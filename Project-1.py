...
# You are given a lot of png files and the text whats you have to put after the png files so that it could look like a newspaper 
...
root = Tk()
root.title("bikash1317 News - Your Newspaper")
...
for i in range(0, 3):
    ...
    # TODO:Resize these images ANTIALIAS=used to decrease the blurry in image
    image = image.resize((225, 265), Image.ANTIALIAS)
    photos.append(ImageTk.PhotoImage(image))

f0 = Frame(root, width=800, height=70)
Label(f0, text="Bikash Kumar Dash News", font="lucida 33 bold").pack()
