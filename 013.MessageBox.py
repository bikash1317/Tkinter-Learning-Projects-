...
def help():
    ...
    tmsg.showinfo("Help", "Bikash will help you with this gui")
...
def Bikash():
    ans = tmsg.askretrycancel("Bikash se dosti kar lo", "Sorry Bikash nahi banega aapka dost")
    if ans:
...
m3.add_command(label = "Bestfriend Bikash", command=Bikash)
